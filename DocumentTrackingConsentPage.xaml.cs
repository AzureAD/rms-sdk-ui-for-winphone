...
namespace Microsoft.RightsManagement.UI.RMSCustomControls
{
    ...
    /// </summary>
    public sealed partial class DocumentTrackingConsentPage : Page
    {
        private AsyncUIOperation<ConsentUIResult> asyncOperation;

        public DocumentTrackingConsentPage()
        {
        ...
        public static IAsyncOperation<ConsentUIResult> ShowDocumentTrackingConsentPage()
        {
            var context = new DocumentTrackingConsentPageContext()
            {
            ...
            coreWindow.Dispatcher.RunAsync(
                   ...
                   () => currentPage.Navigate(typeof(DocumentTrackingConsentPage), context));
        ...
        {
            var context = e.Parameter as DocumentTrackingConsentPageContext;
            if (context != null)
            {
        ...
        private async void AcceptButtonClick(object sender, RoutedEventArgs e)
        {
            ...
            if (this.asyncOperation.Status == AsyncStatus.Started) this.asyncOperation.Complete(result);
            await this.GoBack();
        }
